...
function Be(e) {
  var E;
  const { position: t, containerClassName: n, rtl: a = false, style: o = {} } = e, s = r.CSS_NAMESPACE, d = $e(t), y = document.querySelector(".".concat(s)), u = document.querySelector(".".concat(d)), C = !!u && !((E = u.className) != null && E.includes(Q)), c = y || document.createElement("div"), v = document.createElement("div");
  v.className = qe(
    t,
    n,
    a
...
var Qe = defineComponent({
  ...
  setup(e, {
    ...
    })), s = computed(() => ["".concat(r.CSS_NAMESPACE, "__progress-bar"), e.controlledProgress ? "".concat(r.CSS_NAMESPACE, "__progress-bar--controlled") : "".concat(r.CSS_NAMESPACE, "__progress-bar--animated"), "".concat(r.CSS_NAMESPACE, "__progress-bar-theme--").concat(e.theme), "".concat(r.CSS_NAMESPACE, "__progress-bar--").concat(e.type), e.rtl ? "".concat(r.CSS_NAMESPACE, "__progress-bar--rtl") : null].filter(Boolean).join(" ")), d = computed(() => "".concat(s.value, " ").concat((t == null ? void 0 : t.class) || "")), y = () => {
...
function ot(e) {
  ...
  }), d = s.done || nt, y = computed(() => s.appendPosition ? "".concat(s.enter, "--").concat(s.position) : s.enter), u = computed(() => s.appendPosition ? "".concat(s.exit, "--").concat(s.position) : s.exit), C = computed(() => e.pauseOnHover ? {
    onMouseenter: M,
    onMouseleave: B
  } : {});
  function c() {
